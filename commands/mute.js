...
//console.log(args[2]);//time
  ...
  if(message.member.hasPermission("ADMINISTRATOR")) {
            ...
            if(!member2) return message.reply(":x: " + "| Silahkan Mention target!");
            ...
            if(!time2) {
              ...
              message.channel.send(member2 + ` Kamu telah diberikan role: ` + muteRole2.name);
            }else {
              member2.addRole(muteRole2.id);
              message.channel.send(member2 + ` Kamu telah diberikan role: ` + muteRole2.name + ` for: ${ms(ms(time2), {long: true})}`);
              ...
              setTimeout(function(){
                ...
                return message.reply(":x: " + "| Maaf kamu tidak ada izin")
              };
}
