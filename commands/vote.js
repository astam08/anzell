...
exports.run = async (client, message, args) => {
    ...
    try {
        ...
        if (timeS == '' && votingthing == '') return message.reply("I can't deploy a vote with no parameters! Please use `F!help vote` for more info on how to use this command!");
        if (votingthing == '') return message.reply("I can't deploy a vote with no parameters! Please use `F!help vote` for more info on how to use this command!");
...
exports.help = {
    ...
    usage: "`F! vote <channel to send vote in> <seconds for vote to last> <vote message>`"
}