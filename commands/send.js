exports.run = (client, message, args) => {
    ...
    if (chanSendFind === false) return message.reply('you need to specify a channel to send this message in. `F!send #<channel_name> <content>`');
...
exports.help = {
    ...
    usage: "`F!send #<channel> <content of the message>`"
}